...
export default function ProfilePage() {
  ...
  return state ? (
    <div className="w-full min-h-[500px] max-w-[429px] self-center mx-auto rounded-lg gap-8 p-4 my-2 flex flex-col lg:flex-row lg:items-start items-center">
      <div
      ...
      >
        <img
          ...
          src={import.meta.env.VITE_API + "public/" + state.profilePicture}
        />
